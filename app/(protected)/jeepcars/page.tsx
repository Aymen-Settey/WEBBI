...
const JEEPCARSDashboard = () => {
  ...
  return (
    <RoleGate allowedRole={[UserRole.COMMVNJEEP]}>
      <div style={containerStyle}>
        <iframe
          ...
          style={iframeStyle}
          allowFullScreen
          src="https://app.powerbi.com/view?r=eyJrIjoiOGY1ZmE3ZTAtOTJmZi00ZTY0LTljNGQtY2FmY2QwNGVlZWYwIiwidCI6IjVkNjBmZmVkLTViNWUtNDU0ZC05MjU3LWMwNTZhMzU3MTc0NCJ9"
        ></iframe>
      </div>
    </RoleGate>
  );
...
export default JEEPCARSDashboard;
