...
const SAVKHDashboard = () => {
  ...
  return (
    <RoleGate allowedRole={[UserRole.SAVKHADHRA]}>
      <div style={containerStyle}>
        <iframe
          ...
          style={iframeStyle}
          allowFullScreen
          src="https://app.powerbi.com/view?r=eyJrIjoiYzVmMmUxMDAtZTlkNC00MDMwLTkxNmQtZmZiNDNmZDZmYTNjIiwidCI6IjVkNjBmZmVkLTViNWUtNDU0ZC05MjU3LWMwNTZhMzU3MTc0NCJ9"
        ></iframe>
      </div>
    </RoleGate>
  );
