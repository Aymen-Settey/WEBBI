...
const SAVMEGDashboard = () => {
  ...
  return (
    <RoleGate allowedRole={[UserRole.SAVMEG, UserRole.DTFIAT]}>
      <div style={containerStyle}>
        <iframe
          ...
          style={iframeStyle}
          allowFullScreen
          src="https://app.powerbi.com/view?r=eyJrIjoiY2EyNTAzMTItYzc3Ny00NzZlLTllOTgtMTUxOTA2MmZlODRmIiwidCI6IjVkNjBmZmVkLTViNWUtNDU0ZC05MjU3LWMwNTZhMzU3MTc0NCJ9"
        ></iframe>
      </div>
    </RoleGate>
  );
...
export default SAVMEGDashboard;
