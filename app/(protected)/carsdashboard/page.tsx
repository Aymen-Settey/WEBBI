  ...
  return (
    ...
    >
      <div style={containerStyle}>
        <iframe
          title="ITALCAR_DASH_VOITURES_SA"
          style={iframeStyle}
          allowFullScreen
          src="https://app.powerbi.com/view?r=eyJrIjoiZTJhOWFjMmEtYzI3Ni00NjJjLTkzNGQtYzZkOGMzNjUwZjA5IiwidCI6IjVkNjBmZmVkLTViNWUtNDU0ZC05MjU3LWMwNTZhMzU3MTc0NCJ9"
        ></iframe>
      </div>{" "}
    </RoleGate>
  );
