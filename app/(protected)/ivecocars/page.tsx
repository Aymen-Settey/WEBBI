...
const IVECOCARSDashboard = () => {
  ...
  return (
    <RoleGate allowedRole={[UserRole.COMMVNIVECO]}>
      <div style={containerStyle}>
        <iframe
          ...
          style={iframeStyle}
          allowFullScreen
          src="https://app.powerbi.com/view?r=eyJrIjoiOWVmMzAxNGMtY2Q2OS00NzI2LWJlMjEtMmIwNmFlODk4YWY2IiwidCI6IjVkNjBmZmVkLTViNWUtNDU0ZC05MjU3LWMwNTZhMzU3MTc0NCJ9"
        ></iframe>
      </div>
    </RoleGate>
  );
...
export default IVECOCARSDashboard;
